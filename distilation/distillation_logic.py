...
import copy
import datetime
from distillation import WhiteBoxDistillation, BlackBoxDistillation, DistillationConfig, create_optimizer
...
def parse_args():
    ...
    parser.add_argument('--box', type=str, default='white', choices=['white', 'black'], help='Тип дистилляции: white-box (с доступом к логитам) или black-box (только предсказания)')
...
def distill_gpt2_wikitext(args):
    ...
    # Создаем модуль дистилляции в зависимости от выбранного типа
    distiller = create_optimizer("distillation", vars(distillation_config), box_type=args.box)
